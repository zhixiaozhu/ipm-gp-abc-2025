...
abcresult = whole_year.ABC_SMC(quantiles=np.array([0.55, 0.5, 0.45, 0.4, 0.35, 0.3, 0.2, 0.15, 0.1, 0.088]),
                                n_particles=np.array([1000000, 500000, 300000, 150000, 100000, 60000, 30000, 15000, 7000, 1000]))
