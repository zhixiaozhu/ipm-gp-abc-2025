...
num_burnin_steps = ci_niter(7000)
...
adaptive_hmc = tfp.mcmc.SimpleStepSizeAdaptation(
    hmc, num_adaptation_steps=int(num_burnin_steps * 0.65), target_accept_prob=f64(0.81), adaptation_rate=0.13
)
...
pickle.dump(samples, open(file = os.getcwd()+f"/true_popu/gp_mle_true_population/MCMC/gp/sep/samples_fec.pkl", mode="wb"))