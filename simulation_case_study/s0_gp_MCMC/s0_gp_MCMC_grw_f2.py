...
num_burnin_steps = ci_niter(3000)
num_samples = ci_niter(5000)

hmc = tfp.mcmc.HamiltonianMonteCarlo(
    target_log_prob_fn=hmc_helper.target_log_prob_fn, num_leapfrog_steps=10, step_size=6
)
...
pickle.dump(samples, open(file = os.getcwd()+f"/true_popu/gp_mle_true_population/MCMC/gp/sep/samples_grw_f.pkl", mode="wb"))
