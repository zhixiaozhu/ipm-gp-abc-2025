...
hmc = tfp.mcmc.HamiltonianMonteCarlo(
    target_log_prob_fn=hmc_helper.target_log_prob_fn, num_leapfrog_steps=10, step_size=f64(0.01)
)
...
pickle.dump(samples, open(file = os.getcwd()+f"/true_popu/glm_mle_true_population/MCMC/gp/sep/samples_flow.pkl", mode="wb"))