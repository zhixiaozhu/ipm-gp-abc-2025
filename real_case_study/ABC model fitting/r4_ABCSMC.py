...
abcresult = whole_year.ABC_SMC(quantiles=np.array([0.55, 0.5, 0.45, 0.4, 0.35, 0.3, 0.2, 0.15, 0.1, 0.088, 0.088]),
                                n_particles=np.array([200000, 120000, 100000, 70000, 50000, 30000, 20000, 10000, 5000, 800, 100]))
